...
CREATE TABLE all_tags(id serial PRIMARY KEY, tag_id VARCHAR NOT NULL, tag_name VARCHAR UNIQUE NOT NULL, tag_type_id INT, FOREIGN KEY(tag_type_id) REFERENCES tag_type(id));
